"""Aplicación ADK Web: propuestas y confirmación de escrituras."""
...
root_agent = build_specialists(EnterpriseTools(EnterpriseDatabase(), WebSearchService()))["action_specialist"]
